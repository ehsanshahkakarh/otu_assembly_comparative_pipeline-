#!/usr/bin/env python3
"""
18S NCBI Merger - Main Entry Point
===================================

Merges 18S eukcensus (eukaryotic) data with NCBI genome data.
...
def main():
    """Main execution function for 18S NCBI merger."""
    ...
    logger.info("=" * 80)
    logger.info("18S NCBI MERGER - Eukaryotic Census + NCBI Genomes")
    logger.info("=" * 80)
    ...
    try:
        ...
        # Final summary
        logger.info("\n" + "=" * 80)
        logger.info("18S NCBI MERGER COMPLETE")
        logger.info("=" * 80)
