#!/usr/bin/env Rscript
#
# 18S Eukaryotic Alluvial Plot Generator - ABSOLUTE VALUES VERSION
# ================================================================
#
...
cat("=== 18S Eukaryotic Alluvial Plot Generator ===\n\n")
...
cat("Creating enhanced 18S alluvial plot...\n")
...
p <- ggplot(long_data,
  ...
  labs(
    ...
    subtitle = paste0("Top 10 shared eukaryotic phyla + Other • Absolute Count:\n",
...
output_base <- "alluvial_18s_ncbi_abs"
...
cat("🧬 18S EUKARYOTIC ALLUVIAL PLOT ANALYSIS SUMMARY\n")
cat(paste(rep("=", 60), collapse = ""), "\n\n")

cat("📊 DATASET OVERVIEW:\n")
cat("   • Total eukaryotic phyla analyzed:", nrow(top_phyla), "\n")
cat("   • Coverage representation: Top 10 by total percentage\n")
cat("   • Data sources: NCBI Genomes → EukCensus Sequences → EukCensus OTUs → NCBI Species\n\n")
...
cat("✅ Enhanced 18S eukaryotic alluvial plot generation completed!\n")
cat(paste(rep("=", 60), collapse = ""), "\n")
...
cat("\n🏆 TOP 15 EUKARYOTIC PHYLA BY TOTAL REPRESENTATION (4-Node Flow):\n")
