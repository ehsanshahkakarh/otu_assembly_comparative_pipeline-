...
cat("\nSaving plot...\n")
ggsave("figures/alluvial_16s_bacteria_pct_values_only.png", p_pct, width = 24, height = 12, dpi = 300, bg = "white")
ggsave("figures/alluvial_16s_bacteria_pct_values_only.pdf", p_pct, width = 24, height = 12, dpi = 300, bg = "white")
