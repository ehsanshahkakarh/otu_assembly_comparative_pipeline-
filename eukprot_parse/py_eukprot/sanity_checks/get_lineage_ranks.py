...
This script reads taxids from phylum_taxids_only.txt and uses taxonkit
...
Output:
    phylum_lineage_ranks.txt: A tab-separated file with taxid, lineage, and rank columns
"""
...
def get_lineage_ranks():
    ...
    input_file = "phylum_taxids_only.txt"
    output_file = "phylum_lineage_ranks.txt"
