...
def process_archaeal_groups():
    ...
    for level in counts_files.keys():
        try:
            ...
            filtered_counts = counts_df[counts_df['domain'].str.strip().str.lower() == 'archaea']
            filtered_accessions = accessions_df[accessions_df['domain'].str.strip().str.lower() == 'archaea']
