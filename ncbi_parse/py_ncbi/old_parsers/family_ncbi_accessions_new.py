#!/usr/bin/env python3
"""
NCBI Family Accessions Builder
...
Output:
- Total genome accessions with classification (ncbi_family_with_accessions_classified.csv)
- Species subset accessions with classification (ncbi_family_species_subset_with_accessions_classified.csv)

Usage:
    python family_ncbi_accessions.py [--input-dir INPUT_DIR] [--output-dir OUTPUT_DIR]
"""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Build NCBI family accession files with genome source classification")
...
def main() -> int:
    """Main function to run the family accessions builder."""
    args = parse_arguments()

    try:
        # Set up logging
        log_file = setup_logging("family_ncbi_accessions")
        logging.info("Starting family NCBI accessions builder")
        ...
        columns_to_include = ['assembly_accession', 'family', 'domain', 'taxid', 'genome_source']
        ...
        total_output_file = output_dir / "ncbi_family_with_accessions_classified.csv"
        ...
        species_output_file = output_dir / "ncbi_family_species_subset_with_accessions_classified.csv"
        ...
        logging.info("Family NCBI accessions builder completed successfully")
        return 0
