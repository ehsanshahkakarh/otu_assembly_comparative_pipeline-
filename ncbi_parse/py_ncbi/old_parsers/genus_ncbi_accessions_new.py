...
Output:
- Total genome accessions with classification (ncbi_genus_with_accessions_classified.csv)
- Species subset accessions with classification (ncbi_genus_species_subset_with_accessions_classified.csv)

Usage:
    python genus_ncbi_accessions.py [--input-dir INPUT_DIR] [--output-dir OUTPUT_DIR]
"""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Build NCBI genus accession files with genome source classification")
...
def main() -> int:
    """Main function to run the genus accessions builder."""
    args = parse_arguments()
    
    try:
        # Set up logging
        log_file = setup_logging("genus_ncbi_accessions")
        logging.info("Starting genus NCBI accessions builder")
        ...
        columns_to_include = ['assembly_accession', 'genus', 'domain', 'taxid', 'genome_source']
        ...
        total_output_file = output_dir / "ncbi_genus_with_accessions_classified.csv"
        ...
        species_output_file = output_dir / "ncbi_genus_species_subset_with_accessions_classified.csv"
        ...
        logging.info("Genus NCBI accessions builder completed successfully")
        return 0
