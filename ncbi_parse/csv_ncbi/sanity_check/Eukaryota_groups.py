...
def process_taxonomic_groups():
    """Process CSV files to extract unique taxonomic groups for Eukaryota with their taxids."""
    ...
    output_files = {
        'genus': output_dir / "eukaryotic_genera.csv",
        'family': output_dir / "eukaryotic_families.csv",
        'phylum': output_dir / "eukaryotic_phyla.csv"
    }
    ...
    for level, input_file in input_files.items():
        try:
            ...
            filtered_df = df[df['domain'].str.strip().str.lower() == 'eukaryota']
