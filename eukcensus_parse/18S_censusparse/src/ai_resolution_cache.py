#!/usr/bin/env python3
"""
AI Resolution Cache Manager
============================

Manages persistent caching of AI-researched taxonomic resolutions.
Implements cache-first approach: check cache before doing AI web search.

This module is part of the 18S census parser pipeline and provides
persistent storage for AI-researched taxonomic resolutions.
"""
...
def get_default_cache_path() -> Path:
    ...
    return Path(__file__).parent.parent / "cache" / "ai_resolutions.json"
        ...
        if self.cache_file.exists():
            ...
            return {
                "metadata": {
                    ...
                    "total_resolutions": 0,
                    "version": "1.0",
                    "description": "AI-researched taxonomic resolutions for 18S census data"
                },
                "resolutions": {}
            }
